...
export const SideLinks = ({
    ...
    const sideLinkItems = linkList.map((linkItem, index) => {
        ...
        const sizedIconComponent = iconComponent;
        ...
        return (
            ...
            >
                <div className="py-4 transition-transform ease-in-out duration-300 hover:-translate-y-2">
                    <a
                        href={link}
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label={description}
                        className="text-bright h-10 opacity-60"
                    >
                        {sizedIconComponent}
                    </a>
                </div>
    ...
    return (
        <div className="fixed w-10 bottom-4 sm:bottom-12 left-4 sm:left-14">
            <ul className="list-none">{sideLinkItems}</ul>
        </div>
    );
};

export const AnimatedSubtext = ({
    staticText,
    animatedText,
...
export const SkillsSection = ({
    ...
    const languagesTitle = useRef<HTMLHeadingElement | null>(null);
    const languagesContainer = useRef<HTMLDivElement | null>(null);
    const technologiesTitle = useRef<HTMLHeadingElement | null>(null);
    const technologiesContainer = useRef<HTMLDivElement | null>(null);
    const toolsTitle = useRef<HTMLHeadingElement | null>(null);
    ...
    const projects = [
        {
            ...
            gh_link: "https://github.com/devmwang/OpenCloud",
            skills: [
                "Node.js",
                "TypeScript",
                "Fastify",
        ...
        },
        {
            ...
            gh_link: "https://github.com/devmwang/GTA-Pilot",
            skills: ["Python", "C++", "PyTorch", "ZeroMQ", "OpenCV", "NumPy"],
        },
        {
